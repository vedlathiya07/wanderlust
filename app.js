...
app.param('id', (req, res, next, val) => {
    try { req.params.id = decodeId(val); } catch (e) { }
    next();
});
app.param('bookingId', (req, res, next, val) => {
    try { req.params.bookingId = decodeId(val); } catch (e) { }
    next();
});
app.param('reviewId', (req, res, next, val) => {
    try { req.params.reviewId = decodeId(val); } catch (e) { }
    next();
});
